    ...
    useEffect(() => {
        if (p['data-organization']) {
            ...
            setOrganization({
                ...
                street_1: localStorage.getItem('street_1') || '',
                street_2: localStorage.getItem('street_2') || '',
                city_town: localStorage.getItem('city_town') || '',
                state_province: localStorage.getItem('province_state') || '',
                postal_zip_code: localStorage.getItem('postal_zip_code') || '',
			...
			<DescriptionList className="hidden sm:block">
				...
				<DescriptionDetails>
					<Link href={`tel:${organization?.phone}`} className="hover:text-white">
						{organization?.phone || ''} {organization?.local_time || ''}
					</Link>
				</DescriptionDetails>
