...
export default function AthleteForm(props: { 'data-athlete': Record<string, any> }) {
    const ctx = useAppContext()
	const [payload, setPayload] = useState(props['data-athlete'] || {})
			...
			<div className="space-y-12">
				<div className="border-b border-gray-900/10 pb-12 dark:border-white/10">
                    <p className="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">
                        Please fill out this form to update your child&rsquo;s soccer player profile. This helps us keep their information accurate and up to date.
                    </p>
					...
					<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
							...
							<div className="mt-2">
								<div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 dark:bg-white/5 dark:outline-white/10 dark:focus-within:outline-indigo-500">
									<div className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6 dark:text-gray-400">
										clubathletix.com/profile/
									</div>
									<input
										id="username"
										name="username"
										type="text"
										placeholder={payload.slug}
						...
						<Field className="col-span-full start-from-1">
							<Label>About</Label>
                            <Textarea
                                name="player_notes"
                                rows={3}
                                defaultValue={payload.player_notes || ''}
                            />
							
							<Text>Write a few sentences about yourself.</Text>
						</Field>

						<Field className="lg:col-span-1">
							<Label htmlFor="cover-photo">Profile photo</Label>
							<div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-white/25">
								<div className="text-center">
									<UserCircleIcon aria-hidden="true" className="mx-auto size-12 text-gray-300 dark:text-gray-600" />
									<div className="mt-4 flex flex-col text-sm/6 text-gray-600 dark:text-gray-400">
                                        <label
                                            htmlFor="file-upload"
                                                ...
                                                onChange={e => {
                                                    ...
                                                    if (file) {
                                                        ...
                                                        reader.onload = e => {
                                                            ...
                                                            setPayload(prev => ({ ...prev, profilePhotoBase64: base64 }))
                                                            // Optionally, you can set a preview image src here
                                                        }
